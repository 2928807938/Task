...
const PriorityListEditor: React.FC<Props> = ({ items, onAdd, onRemove }) => {
  ...
  return (
    <div className="mt-4">
      <h6 className="text-sm font-medium mb-2">自定义优先级</h6>
      ...
      {items.length > 0 ? (
        ...
        <p className="text-xs text-gray-500 italic">尚未添加自定义优先级</p>
      )}
...
export default PriorityListEditor;
